...
exports.ProfilerGameProfiler = void 0;
...
class ProfilerGameProfiler {
    ...
    profile(duration, filter) {
        profiler_1.Profiler.setupMemory('profile', duration || 100, filter);
    }
    /**
    ...
    stream(duration, filter) {
        profiler_1.Profiler.setupMemory('stream', duration || 10, filter);
    }
    /**
    ...
    email(duration, filter) {
        profiler_1.Profiler.setupMemory('email', duration || 100, filter);
    }
    /**
     ...
     */
    background(filter) {
        profiler_1.Profiler.setupMemory('background', false, filter);
    }
    /**
    ...
    callgrind(duration, filter) {
        profiler_1.Profiler.setupMemory('callgrind', duration || 100, filter);
    }
    /**
     ...
     */
    output(limit) {
        profiler_1.Profiler.output(limit);
    }
    /**
